            ...
            <div class="collapse navbar-collapse" id="navbarNavAltMarkup"> 
                <div class="navbar-nav"> 
                    ...
                    <?php if (!empty($this->session->userdata('email'))) { ?> 
                        ...
                        <a class="nav-item nav-link" href="<?= base_url('member/logout'); ?>"><i class="fas fa-fw fa-login"></i> Log out</a> 
                    <?php } else { ?> 
                        <a class="nav-item nav-link" data-toggle="modal" data-target="#daftarModal" href="#"><i class="fas fa-fw fa-login"></i> Daftar</a> 
                        <a class="nav-item nav-link" data-toggle="modal" data-target="#loginModal" href="#"><i class="fas fa-fw fa-login"></i> Log in</a> 
                    <?php } ?> 
                    <span class="nav-item nav-link" style="display:block; margin-left:20px;">Selamat Datang <b><?= $user; ?></b></span> 
                </div> 
            </div> 
        </div> 
    </nav> 
